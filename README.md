...
- Matheus Henrique de Lima (https://github.com/mahenrique)
- Plínio Mendonça

### Agradecimentos
Agradeço a UniDombosco por oferecer esta oportunidade em construir este software para a matéria Laboratório de Engenharia de Software.

## Licença
A estrutura do Oficina Mecânica é um software de código aberto licenciado sob a(/LICENSE).
